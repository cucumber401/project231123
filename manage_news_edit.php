...
if (isset($_GET["action"]) && $_GET["action"] == "edit") {
  ...
  SET n_start_date=?, n_end_date=?, n_title=?, n_content=?, n_type=?
  WHERE n_id=?";
...
<body>
  ...
  <div class="container rounded-4">
    <div class="pt-2 pb-0">
      ...
      <hr><br>
      <form action="./manage_news_edit.php" method="get">
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-md-6">
            <textarea class="form-control" name="n_content" id="n_content" cols="50" rows="7" required><?php echo $n_content ?></textarea>
          </div>
        </div>
        <div class="mb-3 row">
