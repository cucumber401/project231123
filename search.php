...
$sql_query = "SELECT * FROM products WHERE p_name LIKE '%$search_keywords%'";
...
<body>
  ...
  <div class="container">
    <h3>以下是包含「<strong><?php echo $search_keywords; ?></strong>」的產品搜尋結果：</h3>
    <p class="lead">共<?php echo $result->num_rows;?>筆</p>
  </div>
            ...
            <div class="card-body">
              ...
              <div class="btnDIV position-relative">
                <a href="./product.php?p_id=<?php echo $i_result['p_id'] ?>">
                  <img class="card-img-top" src="./photo/pro_home/<?php echo $i_result['p_pic'] ?>">
