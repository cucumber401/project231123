    ...
    <div class="pt-2 pb-0">
      ...
      <form action="./manage_orders_del.php" method="get">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-md-6">
            <input type="datetime-local" class="form-control" name="o_trade_date" id="o_trade_date" value="<?php echo $o_trade_date ?>" disabled readonly>
          </div>
        </div>
        <div class="mb-3 row">
          <label for="o_pay_date" class="offset-md-2 col-md-2 col-form-label">訂單付款時間</label>
          <div class="col-md-6">
            <input type="datetime-local" class="form-control" name="o_pay_date" id="o_pay_date" value="<?php echo $o_pay_date ?>" disabled readonly>
          </div>
        </div>
