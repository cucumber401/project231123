...
if (isset($_GET["action"]) && $_GET["action"] == "edit") {
  ...
  $sql_query = "UPDATE members 
  SET m_name=?, m_sex=?, m_birthday=?, m_email=?, m_phone=?, m_addr=? 
  WHERE m_id=?";
...
<body>
  ...
  <div class="container rounded-4">
    <div class="pt-2 pb-0">
      ...
      <form action="./manage_members_edit.php" method="get">
        <div class="mb-3 row">
          <label for="m_name" class="offset-md-2 col-md-2 col-form-label">姓　　名</label>
          <div class="col-md-6">
            <input type="text" class="form-control" name="m_name" id="m_name" value="<?php echo $m_name; ?>" required>
          </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-md-6">
            <input type="email" class="form-control" name="m_email" id="m_email" value="<?php echo $m_email; ?>" maxlength="50">
          </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
          <div class="offset-md-3 col-md-6 text-center">
            ...
            <button class="btn btn-primary mx-4" type="submit">更新資料</button>
